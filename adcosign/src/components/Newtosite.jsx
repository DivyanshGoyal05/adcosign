        ...
        <div className="container px-5 pb-10  mx-auto flex flex-wrap">
          ...
          <div className="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
            ...
            <path d="M12 22V8M5 12H2a10 10 0 0020 0h-3"></path>
              ...
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">
                  Get contract request Or Send connection request to various brands
                </h2>
                <p className="leading-relaxed">
                  Your profile will be shown to brands based on rating and
                  search criteria,If any brands are interested then you will get
          ...
          <div className="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
            ...
            <path d="M12 22V8M5 12H2a10 10 0 0020 0h-3"></path>
              ...
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">
                  {" "}
                  Get contract request Or Send connection request to influencer
                </h2>
                <p className="leading-relaxed">
          ...
          <div className="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
            ...
            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                ...
                <p className="leading-relaxed">
                  After making successfull connection ,Decide term & conditions
