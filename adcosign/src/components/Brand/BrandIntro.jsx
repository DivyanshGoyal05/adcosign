                    ...
                    <div className='text-left'>
                        ...
                        <div className=''>
                            ...
                            <div className='text-5xl font-medium mt-20'>
                                <div className=''>Get Influncer Analytics 
                                </div>
                                <span>and get the best Influncer to Advertise your brand.
                                </span>
                        ...
                        <div className=''>
                            ...
                            <div className='text-2xl pt-8 max-w-4xl'>
                                With our 25k+ micro-influencers you can choose from a variety of Influencers and control the ROI on your campaigns
                            </div>
                            <div className='flex'>
