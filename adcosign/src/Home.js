        ...
        <div className=' flex  items-center  '>
          <div className='text-left'>
            <div className='text-5xl font-medium'>
              Collabify generates sales to brands via micro-influencers
            </div>
      ...
      <div className=''>
        ...
        <div className='w-5/6 m-auto text-left'>
          ...
          <div className='text-2xl pt-8 max-w-4xl'>
            More than 200+ brands world-wide cooperate with Collabify influencers. No matter how many followers you have - you can earn with us </div>
          <div className='flex'>
